...
public partial class DbComment2Context : DbContext
{
    public DbComment2Context()
    {
    }

    public DbComment2Context(DbContextOptions<DbComment2Context> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=66.23.236.70;Initial Catalog=dbcomments2;User Id=userdbcomments2;Password=kBn74YP$yvjahj_1;TrustServerCertificate=True;Connection Timeout=300;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.HasDefaultSchema("userdbcomments2");
        ...
        modelBuilder.Entity<TblDefCommentLike>(entity =>
        {
            ...
            entity.HasOne(d => d.Comment).WithMany(p => p.TblDefCommentLikes)
                ...
                .HasConstraintName("FK_TblDefCommentLikes_TblDefComments");
        });
