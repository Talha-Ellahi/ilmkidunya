...
namespace IKDFrontEnd.BackupModel1;

public partial class Dbikd1Context : DbContext
{
    public Dbikd1Context()
    {
    }

    public Dbikd1Context(DbContextOptions<Dbikd1Context> options)
        : base(options)
    {
    }
    ...
    {
        modelBuilder.HasDefaultSchema("userdbikd1_26");
